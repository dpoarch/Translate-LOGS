...
namespace SpencerGifts.Translate.Tlog.SGPYTECH
{
    class SGTLOGFORMAT
    {
        ...
        public string INPUTDIR = "F:\\Test\\SGTLOGFORMAT\\INPUTDIR\\";
        public string OUTPUTDIR = "F:\\Test\\SGTLOGFORMAT\\OUTPUTDIR\\";
        public string PROGDIR = "F:\\Test\\SGTLOGFORMAT\\PROGDIR\\";
        public string WORKDIR = "F:\\Test\\SGTLOGFORMAT\\WORKDIR\\";
        ...
        public void program1()
        {
            ...
            var dos_string1 = PROGDIR;
            var dos_string2 = prog1;
            var dos_string3 = INPUTDIR;
            var dos_string4 = inputfile;
            var dos_string5 = OUTPUTDIR;
        ...
        public void delete_tlog_go_file()
        {
            ...
            var dos_string = "cmd /c del " + INPUTDIR + "pt_tlog.GO";
            Console.WriteLine("***** FILE XX ****");
            Console.WriteLine(" ");
            Console.WriteLine(dos_string);
            Console.WriteLine(" ");
        ...
        public void delete_filea()
        {
            ...
            var dos_string = "cmd /c del " + INPUTDIR + "tlog.txt";
            Console.WriteLine("***** FILE XX ****");
            Console.WriteLine(" ");
            Console.WriteLine(dos_string);
            Console.WriteLine(" ");
        ...
        {
            var dos_string1 = "cmd /c del " + WORKDIR + "tlog";
            Console.WriteLine("***** FILE XX ****");
            Console.WriteLine(" ");
