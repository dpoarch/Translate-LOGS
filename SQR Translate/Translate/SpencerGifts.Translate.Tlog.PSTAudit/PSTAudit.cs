...
namespace SpencerGifts.Translate.Plugin.TLog.PSTAudit
{
    public class PSTAudit : Translate.TranslateItem
    {
        ...
        public void open_main_file()
        {
            ...
            //var postauditmainfile = base.PluginConfig.GetValue("WORKDIR") + "POSTAUDIT.DAT";
            var postauditmainfile = "C:\\Users\\Gray\\Desktop\\SQRin\\POSTAUDIT.DAT"; // for testing!
        ...
        {
            Console.WriteLine("Begin of the Postaudit Process: ' $AsOfToday ' ' $AsOfNow");
            ...
            Console.WriteLine("End of the Postaudit Process: ' $AsOfToday ' ' $AsOfNow");
            return;
        }
        ...
        {
            var postauditfile1 = base.PluginConfig.GetValue("COPYTO") + postauditfile; //"post_tran_us.txt"
            var postauditbackupfile = base.PluginConfig.GetValue("MOVEFROM") + postauditfile; //"post_tran_us.txt"
            stream = File.Open(postauditfile1, FileMode.Open);
        ...
        public void insert_trans_hdr(string loadrecord, string sep)
        {
            ...
            string store_no_hdr = store_no_hdr_raw.Trim().Substring(6, 5);
        ...
        public void insert_trans_ln(string loadrecord, string sep)
        {
            string[] loadrecordarray = loadrecord.Split(new string[] { sep }, StringSplitOptions.None);
        ...
        public void insert_merchandise_dtl(string loadrecord, string sep)
        {
            string[] loadrecordarray = loadrecord.Split(new string[] { sep }, StringSplitOptions.None);
        ...
        public void insert_disc_dtl(string loadrecord, string sep)
        {
            string[] loadrecordarray = loadrecord.Split(new string[] { sep }, StringSplitOptions.None);
        ...
        public void insert_return_dtl(string loadrecord, string sep)
        {
            string[] loadrecordarray = loadrecord.Split(new string[] { sep }, StringSplitOptions.None);
        ...
        public void insert_sp_ord_dtl(string loadrecord, string sep)
        {
            string[] loadrecordarray = loadrecord.Split(new string[] { sep }, StringSplitOptions.None);
        ...
        public void insert_payroll_dtl(string loadrecord, string sep)
        {
            string[] loadrecordarray = loadrecord.Split(new string[] { sep }, StringSplitOptions.None);
        ...
        public void insert_stock_cntl_dtl(string loadrecord, string sep)
        {
            string[] loadrecordarray = loadrecord.Split(new string[] { sep }, StringSplitOptions.None);
        ...
        public void insert_tax_override_dtl(string loadrecord, string sep)
        {
            string[] loadrecordarray = loadrecord.Split(new string[] { sep }, StringSplitOptions.None);
        ...
        public void insert_post_void_dtl(string loadrecord, string sep)
        {
            string[] loadrecordarray = loadrecord.Split(new string[] { sep }, StringSplitOptions.None);
        ...
        public void insert_auth_dtl(string loadrecord, string sep)
        {
            string[] loadrecordarray = loadrecord.Split(new string[] { sep }, StringSplitOptions.None);
        ...
        public void insert_cust(string loadrecord, string sep)
        {
            string[] loadrecordarray = loadrecord.Split(new string[] { sep }, StringSplitOptions.None);
        ...
        public void insert_cust_dtl(string loadrecord, string sep)
        {
            string[] loadrecordarray = loadrecord.Split(new string[] { sep }, StringSplitOptions.None);
        ...
        public void insert_ln_note(string loadrecord, string sep)
        {
            //#ifdef debuga
        ...
        /// <summary>
        /// The Procedure to refresh all the variables 
        /// </summary>
        public void refresh_variables()
        {
            var if_entry_no_hdr = 0;
            var intf_cntl_flag_hdr = 0;
            var record_type_hdr = " ";
            var store_no_hdr = " ";
            var register_no_hdr = 0;
            var trans_dt_hdr = " ";
            var trans_date_hdr = " ";
            var transaction_date_hdr = " ";
            var entry_datetm_hdr = " ";
            var trans_series_hdr = " ";
            var trans_no_hdr = 0;
            var transaction_no_hdr = 0;
            var cashier_no_hdr = 0;
            var trans_category_hdr = 0;
            var trans_void_flag_hdr = 0;
            var emp_no_hdr = 0;
            var trans_remark_hdr = " ";
            var updated_by_username_hdr = " ";
            var company_no_hdr = 0;
            var if_entry_no_ln = 0;
            var intf_cntl_flag_ln = 0;
            var record_type_ln = " ";
            var line_id_ln = 0;
            var line_object_type_ln = 0;
            var line_object_ln = 0;
            var line_object_ln_cc = 0;
            var line_action_ln = 0;
            var line_action_ln_cc = 0;
            var ref_no_ln = " ";
            var reference_no_ln_cc = " ";
            var gross_line_amt_ln = 0;
            var gross_line_amount_ln_cc = 0;
            var pos_disc_amt_ln = 0;
            var db_cr_none_ln = 0;
            var ref_type_ln = 0;
            var void_rev_flag_ln = 0;
            var line_void_flag_ln = 0;
            var if_entry_no_md = 0;
            var intf_cntl_flag_md = 0;
            var record_type_md = " ";
            var line_id_md = 0;
            var merch_catg_md = 0;
            var upc_lu_div_md = 0;
            var upc_no_md = 0;
            var sku_id_md = 0;
            var style_ref_id_md = 0;
            var class_cd_md = 0;
            var subclass_cd_md = 0;
            var pos_iden_type_md = 0;
            var pos_iden_md = 0;
            var pos_deptclass_md = 0;
            var units_md = 0;
            var sp_md = 0;
            var sp2_md = 0;
            var tick_pr_md = 0;
            ...
            var upc_miss_md = 0;
            var scan_md = 0;
            var if_entry_no_dd = 0;
            var intf_cntl_flag_dd = 0;
            var record_type_dd = " ";
            var line_id_dd = 0;
            var app_by_ln_id_dd = 0;
            var pos_disc_level_dd = 0;
            var pos_disc_type_dd = 0;
            var pos_disc_amt_dd = 0;
            var app_flag_dd = 0;
            var pos_disc_ser_no_dd = " ";
            var if_entry_no_rd = 0;
            var intf_cntl_flag_rd = 0;
            var record_type_rd = " ";
            var line_id_rd = 0;
            var return_reason_msg_rd = " ";
            var return_reason_cd_rd = 0;
            var mdse_disp_cd_rd = 0;
            var via_wh_rd = 0;
            var orig_sp_rd = 0;
            var orig_sp2_rd = 0;
            var return_from_store_rd = " ";
            var return_from_reg_rd = 0;
            var return_from_date_rd = " ";
            var return_from_trans_no_rd = 0;
            var if_entry_no_so = 0;
            var intf_cntl_flag_so = 0;
            var record_type_so = " ";
            var line_id_so = 0;
            var units_so = 0;
            var sp_so = 0;
            ...
            var width_desc_so = " ";
            var vndr_name_so = " ";
            var vndr_style_desc_so = " ";
            var spo_class_desc_so = " ";
            var vndr_no_so = " ";
            var if_entry_no_pd = 0;
            var intf_cntl_flag_pd = 0;
            var record_type_pd = " ";
            var line_id_pd = 0;
            var emp_no_pd = 0;
            var pr_dt_pd = " ";
            var emp_pr_id_pd = " ";
            var emp_type_pd = " ";
            var pr_entry_type_pd = 0;
            var if_entry_no_sc = 0;
            var intf_cntl_flag_sc = 0;
            var record_type_sc = " ";
            var line_id_sc = 0;
            var upc_no_sc = 0;
            var merch_key_sc = 0;
            var ini_by_host_sc = 0;
            var units_sc = 0;
            var oth_str_no_sc = 0;
            var loc_no_sc = 0;
            var vndr_no_sc = " ";
            var cnt_date_sc = " ";
            var if_entry_no_td = 0;
            var intf_cntl_flag_td = 0;
            var record_type_td = " ";
            var line_id_td = 0;
            var tax_level_td = 0;
            var tax_catg_td = 0;
            ...
            var excp_tax_jur_td = " ";
            var tax_exep_no_td = " ";
            var if_entry_no_pv = 0;
            var intf_cntl_flag_pv = 0;
            var record_type_pv = " ";
            var line_id_pv = 0;
            var post_void_reg_pv = 0;
            var post_void_trans_no_pv = 0;
            var post_void_succ_pv = 0;
            var post_void_reason_cd_pv = 0;
            var if_entry_no_ad = 0;
            var intf_cntl_flag_ad = 0;
            var record_type_ad = " ";
            var line_id_ad = 0;
            var card_type_ad = " ";
            var auth_no_ad = " ";
            ...
            var lic_no_ad = " ";
            var pos_st_cd_ad = " ";
            var other_id_type_ad = 0;
            var other_id_ad = " ";
            var def_bill_date_ad = " ";
            var def_bill_plan_ad = 0;
            var cust_sign_obt_ad = 0;
            var if_entry_no_cd = 0;
            var intf_cntl_flag_cd = 0;
            var record_type_cd = " ";
            var from_line_id_cd = 0;
            var cust_role_cd = 0;
            var title_cd = " ";
            var first_name_cd = " ";
            var last_name_cd = " ";
            ...
            var tel_no2_cd = 0;
            var cust_no_cd = 0;
            var if_entry_no_ec = 0;
            var intf_cntl_flag_ec = 0;
            var record_type_ec = " ";
            var from_line_id_ec = 0;
            var cust_role_ec = 0;
            var cust_info_type_ec = 0;
            var cust_info_ec = " ";
            var if_entry_no_lnt = 0;
            var intf_cntl_flag_lnt = 0;
            var record_type_lnt = " ";
            var line_id_lnt = 0;
            var line_note_type_lnt = 0;
            var line_note_lnt = " ";
            return;
        }
        ...
        public void load_postaudit()
        {
            ...
            {
                int IF_ENTRY_NO = Convert.ToInt32(item.IF_ENTRY_NO);
                int INTERFACE_CONTROL_FLAG = Convert.ToInt32(item.INTERFACE_CONTROL_FLAG);
                select_line(IF_ENTRY_NO, INTERFACE_CONTROL_FLAG);
            }
        ...
        public void select_line(int if_entry_no_hdr, int interface_control_flag_hdr)
        {
            datadbDataContext db = new datadbDataContext();
            char giftcard_lnexists = 'N';
            POST_LINE_L_TMP post_line_l_tmp = db.POST_LINE_L_TMPs.FirstOrDefault(i => i.IF_ENTRY_NO == if_entry_no_hdr && i.INTERFACE_CONTROL_FLAG == interface_control_flag_hdr);
            //#ifdef debuga
            ...
            int record_type_ln = Convert.ToInt32(post_line_l_tmp.RECORD_TYPE);
            ...
            char exists = validate_record(line_object_ln, line_action_ln);
            if (exists == 'Y')
            {
                giftcard_lnexists = 'Y';
                process_transln_records(if_entry_no_hdr, line_id_ln, interface_control_flag_hdr, line_object_ln, line_action_ln);
            }

            char cc_exists = validate_cc_record(line_object_ln, line_action_ln);           //Added Murali Kaithi 07/19/07 to process credit card transactions.
            if (cc_exists == 'Y')
            {
                process_cc_transln_records(if_entry_no_hdr, line_id_ln, interface_control_flag_hdr, line_object_ln, line_action_ln);
            }
            ...
            if (giftcard_lnexists == 'Y')
            {
                ...
                //{
                //    insert_giftcard_header();
                //    process_store_date_control();
                //}
            }
            return;
        }

        public char validate_record(int line_object_ln, int line_action_ln)
        {
            datadbDataContext db = new datadbDataContext();
        ...
        public char validate_cc_record(int line_object_ln, int line_action_ln)
        {
            datadbDataContext db = new datadbDataContext();
            char cc_exists = 'N';
        ...
        public void process_transln_records(int if_entry_no_hdr_raw, int line_id_ln_raw, int interface_control_flag_hdr_raw, int line_object_ln_raw, int line_action_ln_raw)
        {
            datadbDataContext db = new datadbDataContext();
            ...
            var if_entry_no_ln = TRANS_LINE_TMP.IF_ENTRY_NO;
            var interface_control_flag_ln = TRANS_LINE_TMP.INTERFACE_CONTROL_FLAG;
            var record_type_ln = TRANS_LINE_TMP.RECORD_TYPE;
            var line_id_ln = TRANS_LINE_TMP.LINE_ID;
            ...
            //process_lnnotedetail_records();

            //if (auth_error_record = "N")
            //{
            //    insert_giftcardln_record();
            //    process_merch_records();
            //    process_discdetail_records();
            //    process_retdetail_records();
            //    process_specialorder_records();
            //    process_payrolldetail_records();
            //    process_stkcntl_records();
            //    process_taxdetail_records();
            //    process_postvoiddetail_records();
            //    process_authdetail_records();
            //    process_custdetail_records();
            //    process_expcustdetail_records();
            //}
            return;
        }

        public void process_cc_transln_records(int if_entry_no_hdr, int line_id_ln, int interface_control_flag_hdr, int line_object_ln, int line_action_ln)
        {
            //#ifdef debuga
            ...
            //if (Convert.ToInt32(store_no_hdr) < 3000 || Convert.ToInt32(store_no_hdr) > 399) //dont know where this came from
            //{
            //    process_recon_post_cc_audit();
            //}

            return;
        }

        public void insert_giftcardln_record(POST_LINE_L_TMP data)
        {
            datadbDataContext db = new datadbDataContext();
        ...
        public void process_merch_records(int if_entry_no_ln, int interface_control_flag_ln, int line_id_ln)
        {
            //#ifdef debuga
        ...
        public void insert_giftcardmerc_record(POST_MERCH_M_TMP data)
        {
            datadbDataContext db = new datadbDataContext();
        ...
        public void process_discdetail_records(int if_entry_no_ln, int interface_control_flag_ln, int line_id_ln)
        {
            //#ifdef debuga
        ...
        public void insert_giftcarddd_record(POST_DETAIL_D_TMP data)
        {
            datadbDataContext db = new datadbDataContext();
        ...
        public void process_retdetail_records(int if_entry_no_ln, int interface_control_flag_ln, int line_id_ln)
        {
            //#ifdef debuga
        ...
        public void insert_giftcardrd_record(POST_RETURN_R_TMP TRANS_RD_TMP)
        {
            datadbDataContext db = new datadbDataContext();
        ...
        public void process_specialorder_records(int if_entry_no_ln, int interface_control_flag_ln, int line_id_ln)
        {
        ...
        public void insert_giftcardso_record(POST_SPEC_ORD_O_TMP TRANS_SO_TMP)
        {
            datadbDataContext db = new datadbDataContext();
        ...
        public void process_payrolldetail_records(int if_entry_no_ln_raw, int interface_control_flag_ln_raw, int line_id_ln_raw)
        {
            //#ifdef debuga
        ...
        public void insert_giftcardpr_record(POST_PAYROLL_P_TMP data)
        {
            datadbDataContext db = new datadbDataContext();
        ...
        public void process_stkcntl_records(int if_entry_no_ln, int interface_control_flag_ln, int line_id_ln)
        {
            datadbDataContext db = new datadbDataContext();
        ...
        public void insert_giftcardsc_record(POST_STOCK_CONTROL_S_TMP data)
        {
            datadbDataContext db = new datadbDataContext();
        ...
        public void process_taxdetail_records(int if_entry_no_ln, int interface_control_flag_ln, int line_id_ln)
        {
        ...
        public void insert_giftcardtx_record(POST_TAX_OVERRIDE_T_TMP data)
        {
            datadbDataContext db = new datadbDataContext();
        ...
        public void process_postvoiddetail_records(int if_entry_no_ln, int interface_control_flag_ln, int line_id_ln)
        {
            //#ifdef debuga
        ...
        public void insert_giftcardpv_record(POST_VOID_V_TMP data)
        {
            datadbDataContext db = new datadbDataContext();
        ...
        public void process_authdetail_records(int if_entry_no_ln, int interface_control_flag_ln, int line_id_ln)
        {
            //#ifdef debuga
        ...
        public void insert_giftcardad_record(POST_AUTH_A_TMP data)
        {
            datadbDataContext db = new datadbDataContext();
            POST_VOID_V_TMP POST_VOID_V = new POST_VOID_V_TMP();
            POST_VOID_V.IF_ENTRY_NO = data.IF_ENTRY_NO;
        ...
        public void process_custdetail_records(int if_entry_no_ln, int interface_control_flag_ln, int line_id_ln)
        {
            //#ifdef debuga
        ...
        public void insert_giftcardcd_record(POST_CUST_C_TMP data)
        {
            datadbDataContext db = new datadbDataContext();
        ...
        public void process_expcustdetail_records(int if_entry_no_ln, int interface_control_flag_ln, int line_id_ln)
        {
        ...
        public void insert_giftcardec_record(POST_CUST_EXTRA_E_TMP data)
        {
            datadbDataContext db = new datadbDataContext();
        ...
        public void process_lnnotedetail_records(int if_entry_no_ln, int interface_control_flag_ln, int line_id_ln)
        {
            ...
            {
                account_balance = 'Y';
                var account_balance_post = Convert.ToInt32(TRANS_LT_TMP.LINE_NOTE);
            }
            if(TRANS_LT_TMP.NOTE_TYPE == 32)
            {
                authorization_found = 'Y';
                var authorization_no_post = TRANS_LT_TMP.LINE_NOTE;
            ...
            {
                var pos_trace_no_post = TRANS_LT_TMP.LINE_NOTE;
            }
            ...
            {
                authorization_found = 'Y';
                var authorization_no_post = "000000";
            ...
            var auth_error_record = 'N'; 
            var authorization_no_post = "999999"; 
            var account_balance_post = 0  ;      
            var pos_trace_no_post = "000000" ;   

            //insert_recon_post_audit();
            }
            else
            {
                var auth_error_record = 'N';
        ...
        public void insert_giftcardlt_record(POST_NOTES_N_TMP data)
        {
        ...
        public void delete_giftcardlt_record(int if_entry_no_ln, int line_id_ln)
        {
        ...
        public void insert_giftcard_header(POST_HEADER_H_TMP data)
        {
            datadbDataContext db = new datadbDataContext();
        ...
        public void process_store_date_control(string store_no_hdr, string transaction_date_hdr)
        {
        ...
        public void update_store_date_control1(string store_no_hdr, string transaction_date_hdr)
       {
           datadbDataContext db = new datadbDataContext();
            //#ifdef debuga
        ...
        public void update_store_date_control2(string store_no_hdr, string transaction_date_hdr)
        {
        ...
        public void insert_store_date_control(STORE_DATE_CONTROL data)
        {
        ...
        public void insert_recon_post_audit(RECON_POST_AUDIT data)
        {
          ...
          //var recon_cat_key = $reference_no_ln||$authorization_no_post||$store_no_hdr||to_char(#transaction_no_hdr)||$recon_date||$recon_amt;

             //var present_date = $AsofToday ||' '||$AsofNow

             //var post_recon_flag = upper($in_auto_recon)

            if(in_auto_recon.ToUpper() == 'N')
            {
               var post_recon_date  = present_date;
               var recon_indicator = 'S';
            }
             else
            {
               var post_recon_date  = "";
            ...
            recon.REFERENCE_NUMBER = data.REFERENCE_NUMBER;
            recon.AUTHORIZATION_NO = data.AUTHORIZATION_NO;
            recon.INTERFACE_CONTROL_FLAG = data.INTERFACE_CONTROL_FLAG;
            recon.STORE_NO = data.STORE_NO;
            recon.REGISTER_NO = data.REGISTER_NO;
            recon.TRANSACTION_DATE = data.TRANSACTION_DATE;
            recon.ENTRY_DATE_TIME = data.ENTRY_DATE_TIME;
            recon.TRANSACTION_SERIES = data.TRANSACTION_SERIES;
            recon.TRANSACTION_NO = data.TRANSACTION_NO;
            recon.CASHIER_NO = data.CASHIER_NO;
            recon.TRANSACTION_CATEGORY = data.TRANSACTION_CATEGORY;
            recon.TRANSACTION_VOID_FLAG = data.TRANSACTION_VOID_FLAG;
            recon.EMPLOYEE_NO = data.EMPLOYEE_NO;
            recon.TRANSACTION_REMARK = data.TRANSACTION_REMARK;
            recon.UPDATED_BY_USER_NAME = data.UPDATED_BY_USER_NAME;
            recon.COMPANY_NO = data.COMPANY_NO;
            recon.LINE_ID = data.LINE_ID;
            recon.LINE_OBJECT_TYPE = data.LINE_OBJECT_TYPE;
            recon.LINE_OBJECT = data.LINE_OBJECT;
            recon.LINE_ACTION = data.LINE_ACTION;
            recon.GROSS_LINE_AMOUNT = data.GROSS_LINE_AMOUNT;
            recon.POS_DISCOUNT_AMOUNT = data.POS_DISCOUNT_AMOUNT;
            recon.DB_CR_NONE = data.DB_CR_NONE;
            recon.REFERENCE_TYPE = data.REFERENCE_TYPE;
            recon.VOIDING_REVERSAL_FLAG = data.VOIDING_REVERSAL_FLAG;
            recon.LINE_VOID_FLAG = data.LINE_VOID_FLAG;
            recon.RECON_MATCH_AUTHCODE = data.RECON_MATCH_AUTHCODE;
            recon.RECON_MATCH_STORE = data.RECON_MATCH_STORE;
            recon.RECON_ACCOUNT_NUMBER = data.RECON_ACCOUNT_NUMBER;
            recon.RECON_TRANSACTION_AMOUNT = data.RECON_TRANSACTION_AMOUNT;
            recon.RECON_TRANSACTION_NO = data.RECON_TRANSACTION_NO;
            recon.RECON_TERMINAL_TRANS_DATE = data.RECON_TERMINAL_TRANS_DATE;
            recon.RECON_CAT_KEY = data.RECON_CAT_KEY;
            recon.CREATE_DATE = data.CREATE_DATE;
            recon.RECON_INDICATOR = data.RECON_INDICATOR;
            recon.RECON_EMP_MOD = data.RECON_EMP_MOD;
            recon.POST_RECON_FLAG = data.POST_RECON_FLAG;
            recon.ACCOUNT_BALANCE = data.ACCOUNT_BALANCE;
            recon.POS_TRACE_NUMBER = data.POS_TRACE_NUMBER;
            recon.POST_RECON_DATE = data.POST_RECON_DATE;
            db.RECON_POST_AUDITs.InsertOnSubmit(recon);
            db.SubmitChanges();

            RECON_POST_AUDIT_PAYTECH paytech = new RECON_POST_AUDIT_PAYTECH();
            paytech.IF_ENTRY_NO = data.IF_ENTRY_NO;
            paytech.REFERENCE_NUMBER = data.REFERENCE_NUMBER;
            paytech.AUTHORIZATION_NO = data.AUTHORIZATION_NO;
            paytech.INTERFACE_CONTROL_FLAG = data.INTERFACE_CONTROL_FLAG;
            paytech.STORE_NO = data.STORE_NO;
            paytech.REGISTER_NO = data.REGISTER_NO;
            paytech.TRANSACTION_DATE = data.TRANSACTION_DATE;
            paytech.ENTRY_DATE_TIME = data.ENTRY_DATE_TIME;
            paytech.TRANSACTION_SERIES = data.TRANSACTION_SERIES;
            paytech.TRANSACTION_NO = data.TRANSACTION_NO;
            paytech.CASHIER_NO = data.CASHIER_NO;
            paytech.TRANSACTION_CATEGORY = data.TRANSACTION_CATEGORY;
            paytech.TRANSACTION_VOID_FLAG = data.TRANSACTION_VOID_FLAG;
            paytech.EMPLOYEE_NO = data.EMPLOYEE_NO;
            paytech.TRANSACTION_REMARK = data.TRANSACTION_REMARK;
            paytech.UPDATED_BY_USER_NAME = data.UPDATED_BY_USER_NAME;
            paytech.COMPANY_NO = data.COMPANY_NO;
            paytech.LINE_ID = data.LINE_ID;
            paytech.LINE_OBJECT_TYPE = data.LINE_OBJECT_TYPE;
            paytech.LINE_OBJECT = data.LINE_OBJECT;
            paytech.LINE_ACTION = data.LINE_ACTION;
            paytech.GROSS_LINE_AMOUNT = data.GROSS_LINE_AMOUNT;
            paytech.POS_DISCOUNT_AMOUNT = data.POS_DISCOUNT_AMOUNT;
            paytech.DB_CR_NONE = data.DB_CR_NONE;
            paytech.REFERENCE_TYPE = data.REFERENCE_TYPE;
            paytech.VOIDING_REVERSAL_FLAG = data.VOIDING_REVERSAL_FLAG;
            paytech.LINE_VOID_FLAG = data.LINE_VOID_FLAG;
            paytech.paytech_MATCH_AUTHCODE = data.paytech_MATCH_AUTHCODE;
            paytech.paytech_MATCH_STORE = data.paytech_MATCH_STORE;
            paytech.paytech_ACCOUNT_NUMBER = data.paytech_ACCOUNT_NUMBER;
            paytech.paytech_TRANSACTION_AMOUNT = data.paytech_TRANSACTION_AMOUNT;
            paytech.paytech_TRANSACTION_NO = data.paytech_TRANSACTION_NO;
            paytech.paytech_TERMINAL_TRANS_DATE = data.paytech_TERMINAL_TRANS_DATE;
            paytech.paytech_CAT_KEY = data.paytech_CAT_KEY;
            paytech.CREATE_DATE = data.CREATE_DATE;
            paytech.paytech_INDICATOR = data.paytech_INDICATOR;
            paytech.paytech_EMP_MOD = data.paytech_EMP_MOD;
            paytech.POST_paytech_FLAG = data.POST_paytech_FLAG;
            paytech.ACCOUNT_BALANCE = data.ACCOUNT_BALANCE;
            paytech.POS_TRACE_NUMBER = data.POS_TRACE_NUMBER;
            paytech.POST_paytech_DATE = data.POST_paytech_DATE;
            db.RECON_POST_AUDITs.InsertOnSubmit(paytech);
            db.SubmitChanges();
            return;
        }

        public void process_recon_post_cc_audit()
        {
            //#debuga   show 'I am in process-recon_post_cc_audit'
            // #debuga show '$entry_date_time_hdr is ' $entry_date_time_hdr

            var store_no_hdr = Convert.ToInt32(store_no_hdr);
        ...
        public void find_transid(int store_no_hdr, int register_no_hdr, string transaction_date_hdr, int transaction_no_hdr)
        {
         var av_trans_id = 0;

              var av_trans_id = av_trans_id;

               find_weborderno();
            datadbDataContext db = new datadbDataContext();
            av_transaction_header av = db.av_transaction_headers.FirstOrDefault(i => i.store_no == store_no_hdr && i.register_no == register_no_hdr && i.transaction_date == transaction_date_hdr && i.transaction_no == transaction_no_hdr);

            find_authno();
            insert_recon_post_cc_audit();
            return;
               }

        public void find_weborderno(int av_trans_id)
        {
          ...
          var weborderno = " ";
            ...
            av_customer customer = db.av_customers.FirstOrDefault(i => i.av_transaction_id == av_trans_id);
              ...
              var weborderno = customer.telephone_no2;

            return;
        }

        public void find_authno(int av_trans_id, int line_id_ln_cc)
        {

          var authno = " ";

         var authorization_no = av_auth.authorization_no;

      
            datadbDataContext db =  new datadbDataContext();
            RECON_POST_CC_AUDIT avauth = db.RECON_POST_CC_AUDITs.FirstOrDefault(i => i.av_transaction_id == i.line_id == line_id_ln_cc);
            var authno = avauth.authorization_no;
            insert_recon_post_cc_audit(avauth);

            return;
        }


        public void insert_recon_post_cc_audit(RECON_POST_CC_AUDIT data)
        {
        ...
        //!  #debuga   show '$recon_date is ' $recon_date
           //move #gross_line_amount_recon to $recon_amt 0999999.99
             ...
             //#debugc show ' '
              ...
              {
              var gross_line_amount_ln_cc = -1 * gross_line_amount_ln_cc;
              }

              if(reference_no_ln_cc.Trim() = null)
              {
            ...
            reconpostaudit.REFERENCE_NUMBER = data.REFERENCE_NUMBER;
            reconpostaudit.STORE_NO = data.STORE_NO;
            reconpostaudit.TRANSACTION_DATE = data.TRANSACTION_DATE;
            reconpostaudit.TRANSACTION_NO = data.TRANSACTION_NO;
            reconpostaudit.LINE_OBJECT = data.LINE_OBJECT;
            reconpostaudit.LINE_ACTION = data.LINE_ACTION;
            reconpostaudit.GROSS_LINE_AMOUNT = data.GROSS_LINE_AMOUNT;
            reconpostaudit.CREATE_DATE = data.CREATE_DATE;
            reconpostaudit.REGISTER_NO = data.REGISTER_NO;
            reconpostaudit.TRANSACTION_ID = data.TRANSACTION_ID;
            reconpostaudit.WEB_ORDER_NO = data.WEB_ORDER_NO;
            reconpostaudit.AUTHORIZATION_NO = data.AUTHORIZATION_NO;
            reconpostaudit.RECON_FLAG = data.RECON_FLAG;
            db.RECON_POST_CC_AUDITs.InsertOnSubmit(reconpostaudit);
            return;
            }


        public void find_recon_date(string transaction_date_hdr)
        {
        ...
        public void select_sysdatetime()
        {
        ...
        //#endif
           ...
           DateTime processed_date = DateTime.Now();
            return;

        }

        public void commit_record()
        {
            datadbDataContext db = new datadbDataContext();
            db.SubmitChanges();
            return;
        ...
        public void delete_go_file()
        {
                System.Diagnostics.Process process = new System.Diagnostics.Process();
                System.Diagnostics.ProcessStartInfo startInfo = new System.Diagnostics.ProcessStartInfo();
                startInfo.WindowStyle = System.Diagnostics.ProcessWindowStyle.Hidden;
                startInfo.FileName = "cmd.exe";
                startInfo.Arguments = "cmd /c del " + base.PluginConfig.GetValue("MOVEFROM") + "US_POST_TRAN.GO";
        ...
        public void delete_processed_files()
        {

            var dos_string = "cmd /c del" + base.PluginConfig.GetValue("COPYTO") + "US_POST_TRAN.*";
        ...
        public void move_files()
        {
           ...
           var dos_string2 = postauditbackupfile;
           var dos_string3 = base.PluginConfig.GetValue("BACKUP") + postauditfile + "." + processed_date;
        ...
        public void copytonew()
        {
            ...
            var dos4 = base.PluginConfig.GetValue("COPYTO");
        ...
        public void files_copy()
        {
            ...
            var dos1 = "cmd /c dir ";
            var dos2 = base.PluginConfig.GetValue("MOVEFROM");
            var dos3 = "US_POST_TRAN.* /ON/B > ";
            var dos4 = base.PluginConfig.GetValue("WORKDIR") + "POSTAUDIT.DAT";
            var dos_string  = dos1 + dos2  + dos3 + dos4;
            //#debuga display '$dos4  '
            //#debuga display  $dos4
        ...
        public void process_CC_file()
        {
        var CCFileName = "pos_sales";
        var CCFileExt = ".txt";
        var CCFullFileName = base.PluginConfig.GetValue("CCDIR") + CCFileName + processed_date + CCFileExt;
        var CCBKUPFileName = base.PluginConfig.GetValue("CCBKDIR") + CCFileName + processed_date + CCFileExt;
        ...
        public void open_Amazon_files()
        {

            var CCFileName_amazon = "pos_sales_amazon";
            var CCFileExt = ".txt";
            var CCFullFileName_amazon = base.PluginConfig.GetValue("CCDIR") + CCFileName_amazon + processed_date + CCFileExt;
            var CCBKUPFileName_amazon = base.PluginConfig.GetValue("CCBKDIR") + CCFileName_amazon + processed_date + CCFileExt;
        ...
        File.AppendAllText(CCFullFileName_amazon, store_no_cc + sep + transdt_cc + sep + amt_cc + sep + web_orderno_cc + sep + no_cc + sep + transid_cc + sep + authno_cc + sep + lineobj_cc);
        File.AppendAllText(CCFullFileName_amazon, store_no_cc + sep + transdt_cc + sep + amt_cc + sep + web_orderno_cc + sep + no_cc + sep + transid_cc + sep + authno_cc + sep + lineobj_cc);

            return;
        }

        public void write_CC_file_Amazon()
        {
            var sep = ',';
